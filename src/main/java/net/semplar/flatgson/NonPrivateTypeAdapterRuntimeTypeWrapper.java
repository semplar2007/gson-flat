 ...
 */
public class NonPrivateTypeAdapterRuntimeTypeWrapper<T> extends TypeAdapter<T> {
    private final Gson context;
    private final TypeAdapter<T> delegate;
    private final Type type;

    public NonPrivateTypeAdapterRuntimeTypeWrapper(Gson context, TypeAdapter<T> delegate, Type type) {
